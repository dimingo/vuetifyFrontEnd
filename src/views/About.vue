  ...
  <div class="About">
    ...
    <v-container class="my-5">
      ...
      <v-expansion-panel v-for="project in myProject" :key="project.title">
        <v-expansion-panel-header class="px-4 grey--text">{{project.title}}</v-expansion-panel-header>
        
        <v-expansion-panel-content class="font-weight-medium" >
          <div  class="caption px-4 font-weight-thin-bold grey--text ">{{project.due}}</div>
         {{project.content}}
